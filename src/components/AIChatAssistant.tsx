        ...
        {!showForm && (
          ...
          >
            ...
            <div className="absolute z-[-1] overflow-hidden h-full w-full rounded-full blur-[3px] 
                            ...
                            before:bg-[conic-gradient(#000,#DB0004_5%,#000_38%,#000_50%,#ff4d4d_60%,#000_87%)] before:transition-all before:duration-2000
                            group-hover:before:rotate-[-120deg] group-focus-within:before:rotate-[420deg] group-focus-within:before:duration-[4000ms]">
            </div>
            <div className="absolute z-[-1] overflow-hidden h-full w-full rounded-full blur-[3px] 
                            before:absolute before:content-[''] before:z-[-2] before:w-[600px] before:h-[600px] before:bg-no-repeat before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:rotate-[82deg]
                            before:bg-[conic-gradient(rgba(0,0,0,0),#8B0000,rgba(0,0,0,0)_10%,rgba(0,0,0,0)_50%,#CC0000,rgba(0,0,0,0)_60%)] before:transition-all before:duration-2000
            ...
            <div className="absolute z-[-1] overflow-hidden h-full w-full rounded-full blur-[2px] 
                            ...
                            before:bg-[conic-gradient(rgba(0,0,0,0)_0%,#ff6b6b,rgba(0,0,0,0)_8%,rgba(0,0,0,0)_50%,#ff8e8e,rgba(0,0,0,0)_58%)] before:brightness-140
            ...
            <div className="absolute z-[-1] overflow-hidden h-full w-full rounded-full blur-[0.5px] 
                            ...
                            before:bg-[conic-gradient(#1c191c,#DB0004_5%,#1c191c_14%,#1c191c_50%,#ff4d4d_60%,#1c191c_64%)] before:brightness-130
            ...
            {/* Main Button */}
            <div className="relative group bg-[#010201] border-none rounded-full flex items-center justify-center"
                 style={{
                   width: '100%',
                   height: '100%',
